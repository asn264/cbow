...
with tf.Graph().as_default():
	...
	with sess.as_default():
		...
		def debug_step(x_batch, y_batch):
			...
			input_x,input_y,E,embedded_tokens,aggregated_embedding, scores, predictions,loss,accuracy,mask = sess.run(
				[cbow.input_x, cbow.input_y, cbow.E, cbow.embedded_tokens, cbow.aggregated_embedding, cbow.scores, cbow.predictions, cbow.loss, cbow.accuracy, cbow.non_zero_mask],
				feed_dict)
